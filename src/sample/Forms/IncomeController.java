...
public class IncomeController {
    ...
    private List<TType> CreateTypes(){
        List<TType> types = new ArrayList<TType>();
        String names []  = {"запрлата","бизнес","девиденды","подарки","подработка"};
...
//        cmb.setButtonCell(new ListCell<TType>(){
//            @Override
//            protected  void updateItem(TType type,boolean empty){
...
//                    setText(null);
//            }
//            protected  void setItems(ObservableList<TType> items){
//
//            }
//        });
    }
    ...
    //TODO: добавление элементов в список истории
